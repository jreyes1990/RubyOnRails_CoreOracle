...
#  encrypted_password(Password/Contrase??a encriptada)                            :string(255)      default(""), not null
...
#  user_created_id(Identificador del usuario al registrar en la aplicaci??n web)  :integer
#  user_updated_id(Identificador del usuario al actualizar en la aplicaci??n web) :integer
#
# Indexes
#
